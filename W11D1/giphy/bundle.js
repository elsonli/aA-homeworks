...
var RECEIVE_SEARCH_GIPHYS = "RECEIVE_SEARCH_GIPHYS"; // export const REQUEST_SEARCH_GIPHYS = 'REQUEST_SEARCH_GIPHYS';
// ----------------------- ACTION CREATORS -----------------------
...
document.addEventListener("DOMContentLoaded", function () {
  var store = Object(_store_store__WEBPACK_IMPORTED_MODULE_2__["default"])(); // At this point, we can also place the Store onto the window for testing
  // window.store = store;
...
var giphysReducer = function giphysReducer() {
  var currState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=RroDn01BjRYZlpI7uMavWwvb9anaEwyL&limit=10")
  });
};
